...
CONFIG = {
    ...
    "debug_panel": None,
    "debug_output_dir": str(_ROOT / ".tmp" / "vallejo_model_color" / "debug"),
}


def parse_vallejo_model_color_images(folder_path=None, output_json=None):
    try:
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Vallejo Model Color PDF parser")
