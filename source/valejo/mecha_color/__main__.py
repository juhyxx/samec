...
CONFIG = {
    "pdf_path": str(_HERE / "MechaColor.pdf"),
    "render_dpi": 300,
    ...
    "swatch_inset": 0.08,
    "output_json": str(_ROOT / "data" / "pack_vallejo_mecha_color.json"),
    "output_csv": str(_ROOT / "data" / "pack_vallejo_mecha_color.csv"),
    "brand_label": "Vallejo Mecha Color",
    "brand_id": "vallejo_mecha_color",
    "debug": False,
    ...
    "debug_panel": None,
    "debug_output_dir": str(_ROOT / ".tmp" / "vallejo_mecha_color" / "debug"),
}


def parse_vallejo_mecha_color_images(folder_path=None, output_json=None):
    try:
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Vallejo Mecha Color PDF parser")
